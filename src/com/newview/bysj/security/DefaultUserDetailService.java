...
import com.newview.bysj.domain.authority.UserRole;
...
public class DefaultUserDetailService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // 获取当前登录系统的user
        com.newview.bysj.domain.authority.User user = userService.uniqueResult("username", username);
        if (user == null) {
            try {
        ...
        List<UserRole> list = userRoleService.list("user", com.newview.bysj.domain.authority.User.class, user);
        // 获取该用户所有的角色名称
